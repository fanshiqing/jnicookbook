...
#include <unistd.h>
#include "jni.h"
#include "recipeNo017_SigTerm.h"
#include "recipeNo017_SigTermExtLib.h"
...
JNIEXPORT void JNICALL Java_recipeNo017_SigTerm_callExitCode
...
JNIEXPORT void JNICALL Java_recipeNo017_SigTermExtLib_callExitCodeExtLib
  (JNIEnv *env, jclass obj) {
